...
- [ ] Configurable AS5600 stall detection thresholds (dead-band, debounce)
- [ ] Feed distance logging and diagnostics via Moonraker API
...
Shipped v1.0 with ~2,400 LOC across firmware (C++), Klipper extra (Python), configs, and docs.
...
- **Tests:** pytest (43 unit tests), hardware test harness (test_protocol.py)
